...
class PickUp(ActionNode,ObjectSpecNode):
    ...
    class SetHolding(StateNode):
        def start(self,event=None):
            ...
            if self.robot.robot0.has_any_barrel() or self.robot.robot0.has_sports_ball():
                ...
                print('Robot now holding', self.parent.object)
                self.post_completion()
            else:
                print('Failed to hold', self.parent.object)
                self.post_failure()
    ...
    class Pickup_Forward(Forward):
        def start(self, event=None):
            if self.parent.object.is_visible:
                ...
                self.distance_mm = sqrt(dx**2 + dy**2) - robot_radius - object_radius + 1
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Fri Jan  2 01:46:31 2026:
        ...
        completiontrans4 .add_sources(forward) .add_destinations(set_hold)
