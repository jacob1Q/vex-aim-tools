...
class DoorPass(StateNode):
    ...
    def start(self, event=None):
        ...
        if isinstance(door, str):
            doorway = self.robot.world_map.objects.get(door)
    ...
    def setup(self):
        ...
        completiontrans7 .add_sources(turn_to_marker1) .add_destinations(marker_forward1)
        ...
        completiontrans8 .add_sources(marker_forward1) .add_destinations(statenode6)
        
        timertrans6 = TimerTrans(0.2) .set_name("timertrans6")
        timertrans6 .add_sources(statenode6) .add_destinations(turn_to_marker2)
        ...
        timertrans7 .add_sources(marker_forward2) .add_destinations(through_door)
        
        completiontrans10 = CompletionTrans() .set_name("completiontrans10")
        completiontrans10 .add_sources(through_door) .add_destinations(parentcompletes1)
