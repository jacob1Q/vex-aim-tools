    ...
    class PilotExecutePlan(StateNode):
        ...
        class ExecuteDrive(StateNode):
            ...
            def start(self, event=None):
                ...
                self.index = 1  # skip the first entry, which should be current pose
                print('ExecuteDrive steps=', self.drive_steps)
                super().start(event)
            ...
            def setup(self):
                ...
                # Code generated by genfsm on Wed Mar 19 01:55:38 2025:
                ...
                completiontrans2 .add_sources(forward) .add_destinations(next)
