...
class PilotBase(StateNode):
    ...
    class PilotExecutePlan(StateNode):
        ...
        class ExecuteDrive(StateNode):
            class TurnStep(ActionNode):
                def start(self,event=None):
                    ...
                    if self.parent.index == len(self.parent.drive_steps) - 1:
                        # last waypoint: turn to specified heading
                        angle_rads = wrap_angle(dest.q - pose.theta)
                    else:
                        # turn to heading needed to reach this waypoint
                        dx = dest.x - pose.x
                        dy = dest.y - pose.y
            ...
            def setup(self):
                ...
                # Code generated by genfsm on Wed Apr 16 04:25:07 2025:
        ...
        def setup(self):
            ...
            completiontrans4 .add_sources(drive) .add_destinations(next)
            
            failuretrans1 = FailureTrans() .set_name("failuretrans1")
            failuretrans1 .add_sources(drive) .add_destinations(parentfails1)
            
            completiontrans5 = CompletionTrans() .set_name("completiontrans5")
            completiontrans5 .add_sources(doorpass) .add_destinations(next)
            
            failuretrans2 = FailureTrans() .set_name("failuretrans2")
            failuretrans2 .add_sources(doorpass) .add_destinations(parentfails2)
            
            completiontrans6 = CompletionTrans() .set_name("completiontrans6")
            completiontrans6 .add_sources(backup) .add_destinations(next)
            ...
            completiontrans7 .add_sources(next) .add_destinations(parentcompletes2)
...
class PilotToObject(PilotBase):
    ...
    def setup(self):
        ...
        completiontrans8 .add_sources(exec) .add_destinations(statenode1)
        ...
        completiontrans9 .add_sources(orienttoobject1) .add_destinations(parentcompletes3)
        
        failuretrans5 = FailureTrans() .set_name("failuretrans5")
        failuretrans5 .add_sources(check) .add_destinations(print2)
...
class PilotToPose(PilotBase):
    ...
    def start(self, event=None):
        ...
        print(f'PilotToPose: navigating to {self.target_pose}')
    ...
    def setup(self):
        ...
        completiontrans10 .add_sources(exec) .add_destinations(check)
        ...
        successtrans4 .add_sources(check) .add_destinations(parentcompletes4)
...
class PilotFrustration(StateNode):
    ...
    def setup(self):
        ...
        completiontrans11 .add_sources(left) .add_destinations(left2)
        
        completiontrans12 = CompletionTrans() .set_name("completiontrans12")
        completiontrans12 .add_sources(right) .add_destinations(right2)
        
        completiontrans13 = CompletionTrans(2) .set_name("completiontrans13")
        completiontrans13 .add_sources(speak,left2,right2) .add_destinations(done)
...
class DoorPass(StateNode):
    ...
    def calculate_gate(self, start_point, door, offset):
        ...
        if dist1sq < dist2sq:
            self.side = +1  # we're on the front side of the wall
            return (pt1x, pt1y, wrap_angle(dtheta+pi))
        else:
            self.side = -1  # we're on the back side of the wall
    ...
    class TravelToGate(PilotToPose):
        ...
        def start(self,event=None):
            pose = self.robot.pose
            (rx, ry, rtheta) = pose.x, pose.y, pose.theta
            (gate_x, gate_y, _) = self.parent.calculate_gate((rx,ry), self.parent.object, offset=self.offset)
            dpose = self.parent.object.pose
            target_theta = dpose.theta if self.parent.side == -1 else dpose.theta + pi
    ...
    class DriveThrough(Forward):
        ...
        def start(self,event=None):
            pose = self.robot.pose
            (rx, ry, rtheta) = pose.x, pose.y, pose.theta
            (gate_x, gate_y, gate_theta) = self.parent.calculate_gate((rx,ry), self.parent.object, offset=5)
    ...
    def setup(self):
        ...
        failuretrans8 .add_sources(check_start) .add_destinations(forward1)
        
        completiontrans14 = CompletionTrans() .set_name("completiontrans14")
        completiontrans14 .add_sources(forward1) .add_destinations(check_start2)
        
        completiontrans15 = CompletionTrans() .set_name("completiontrans15")
        completiontrans15 .add_sources(travel_to_gate1) .add_destinations(statenode2)
        ...
        pilottrans3 .add_sources(travel_to_gate1) .add_destinations(parentfails6)
        
        completiontrans16 = CompletionTrans() .set_name("completiontrans16")
        completiontrans16 .add_sources(align_with_wall) .add_destinations(print4)
        ...
        completiontrans17 .add_sources(center_on_doorway) .add_destinations(print5)
        
        completiontrans18 = CompletionTrans() .set_name("completiontrans18")
        completiontrans18 .add_sources(print5) .add_destinations(through_door)
        
        completiontrans19 = CompletionTrans() .set_name("completiontrans19")
        completiontrans19 .add_sources(through_door) .add_destinations(parentcompletes5)
        
        completiontrans20 = CompletionTrans() .set_name("completiontrans20")
        completiontrans20 .add_sources(away_from_collide) .add_destinations(statenode3)
        ...
        failuretrans9 .add_sources(away_from_collide) .add_destinations(travel_to_gate1)
        ...
        failuretrans10 .add_sources(check_start2) .add_destinations(parentfails7)
        
        completiontrans21 = CompletionTrans() .set_name("completiontrans21")
        completiontrans21 .add_sources(away_from_collide2) .add_destinations(statenode4)
        ...
        failuretrans11 .add_sources(away_from_collide2) .add_destinations(check_start3)
        ...
        failuretrans12 .add_sources(check_start3) .add_destinations(parentfails8)
