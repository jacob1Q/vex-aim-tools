    ...
    class PilotExecutePlan(StateNode):
        ...
        class ExecuteDrive(StateNode):
            ...
            def setup(self):
                ...
                # Code generated by genfsm on Fri Apr 18 23:23:40 2025:
...
class PilotToObject(PilotBase):
    ...
    def setup(self):
        ...
        completiontrans11 .add_sources(orienttoobject1) .add_destinations(parentcompletes4)
...
class PilotToPose(PilotBase):
    ...
    def setup(self):
        ...
        completiontrans12 .add_sources(exec) .add_destinations(check)
...
class PilotFrustration(StateNode):
    ...
    def setup(self):
        ...
        completiontrans13 .add_sources(left) .add_destinations(left2)
        
        completiontrans14 = CompletionTrans() .set_name("completiontrans14")
        completiontrans14 .add_sources(right) .add_destinations(right2)
        
        completiontrans15 = CompletionTrans(2) .set_name("completiontrans15")
        completiontrans15 .add_sources(speak,left2,right2) .add_destinations(done)
...
class DoorPass(StateNode):
    ...
    def setup(self):
        ...
        completiontrans16 .add_sources(forward1) .add_destinations(check_start2)
        
        completiontrans17 = CompletionTrans() .set_name("completiontrans17")
        completiontrans17 .add_sources(travel_to_gate1) .add_destinations(statenode2)
        ...
        completiontrans18 .add_sources(align_with_wall) .add_destinations(print4)
        ...
        completiontrans19 .add_sources(center_on_doorway) .add_destinations(print5)
        
        completiontrans20 = CompletionTrans() .set_name("completiontrans20")
        completiontrans20 .add_sources(print5) .add_destinations(through_door)
        
        completiontrans21 = CompletionTrans() .set_name("completiontrans21")
        completiontrans21 .add_sources(through_door) .add_destinations(parentcompletes6)
        
        completiontrans22 = CompletionTrans() .set_name("completiontrans22")
        completiontrans22 .add_sources(away_from_collide) .add_destinations(statenode3)
        ...
        completiontrans23 .add_sources(away_from_collide2) .add_destinations(statenode4)
