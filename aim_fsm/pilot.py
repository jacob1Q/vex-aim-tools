    ...
    class PilotExecutePlan(StateNode):
        ...
        class ExecuteDrive(StateNode):
            ...
            def setup(self):
                ...
                # Code generated by genfsm on Mon Dec 29 19:56:19 2025:
...
class PilotToObject(PilotBase):
    ...
    def setup(self):
        ...
        completiontrans11 .add_sources(orient) .add_destinations(print3)
        ...
        completiontrans12 .add_sources(center) .add_destinations(print4)
        
        nulltrans4 = NullTrans() .set_name("nulltrans4")
        nulltrans4 .add_sources(print4) .add_destinations(parentcompletes4)
...
class DoorPass(StateNode):
    ...
    def setup(self):
        ...
        completiontrans19 .add_sources(align_with_wall) .add_destinations(print6)
        ...
        completiontrans20 .add_sources(center_on_doorway) .add_destinations(print7)
        
        completiontrans21 = CompletionTrans() .set_name("completiontrans21")
        completiontrans21 .add_sources(print7) .add_destinations(through_door)
        ...
        completiontrans23 .add_sources(away_from_collide) .add_destinations(statenode2)
        ...
        completiontrans24 .add_sources(away_from_collide2) .add_destinations(statenode3)
