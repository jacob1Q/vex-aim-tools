        ...
        class ExecuteDrive(StateNode):
            class TurnStep(ActionNode):
                def start(self,event=None):
                    ...
                    print('TurnStep:', angle_rads, 'radians')
            ...
            def setup(self):
                ...
                # Code generated by genfsm on Mon Mar 17 02:44:45 2025:
...
class PilotToObject(PilotBase):
    ...
    def setup(self):
        ...
        completiontrans8 .add_sources(exec) .add_destinations(check)
...
class PilotToPose(PilotBase):
    ...
    def setup(self):
        ...
        completiontrans9 .add_sources(exec) .add_destinations(check)
...
class PilotFrustration(StateNode):
    ...
    def setup(self):
        ...
        completiontrans10 .add_sources(left) .add_destinations(left2)
        
        completiontrans11 = CompletionTrans() .set_name("completiontrans11")
        completiontrans11 .add_sources(right) .add_destinations(right2)
        
        completiontrans12 = CompletionTrans(2) .set_name("completiontrans12")
        completiontrans12 .add_sources(speak,left2,right2) .add_destinations(done)
