...
class Celeste(StateMachineProgram):
    ...
    class CmdAct(StateNode):
        ...
        def setup(self):
            ...
            # Code generated by genfsm on Sat Jun  7 12:37:46 2025:
    ...
    def setup(self):
        ...
        completiontrans7 .add_sources(speakresponse1) .add_destinations(loop)
        ...
        completiontrans8 .add_sources(cmdsendcamera1) .add_destinations(askgpt2)
        ...
        completiontrans9 .add_sources(dispatch) .add_destinations(loop)
