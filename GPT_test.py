...
class GPT_test(StateMachineProgram):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Sun Jan 26 23:15:24 2025:
        ...
        datatrans6 = DataTrans(re.compile('#turntoward ')) .set_name("datatrans6")
        datatrans6 .add_sources(dispatch) .add_destinations(turntoward)
        
        datatrans7 = DataTrans(re.compile('#drop$')) .set_name("datatrans7")
        datatrans7 .add_sources(dispatch) .add_destinations(cmddrop1)
        
        cnexttrans4 = CNextTrans() .set_name("cnexttrans4")
        cnexttrans4 .add_sources(cmddrop1) .add_destinations(dispatch)
        
        datatrans8 = DataTrans(re.compile('#pickup ')) .set_name("datatrans8")
        datatrans8 .add_sources(dispatch) .add_destinations(pickup)
        
        datatrans9 = DataTrans(re.compile('#camera$')) .set_name("datatrans9")
        datatrans9 .add_sources(dispatch) .add_destinations(cmdsendcamera1)
        ...
        datatrans10 .add_sources(dispatch) .add_destinations(print1)
        ...
        cnexttrans5 .add_sources(turntoward) .add_destinations(dispatch)
        ...
        cnexttrans6 .add_sources(pickup) .add_destinations(dispatch)
