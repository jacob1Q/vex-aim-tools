...
class GPT_test(StateMachineProgram):
    ...
    def setup(self):
        ...
        #       dispatch =D(re.compile('#drop$'))=> Drop() =CNext=> dispatch
        ...
        # Code generated by genfsm on Sat Jan 25 21:50:13 2025:
        ...
        datatrans7 .add_sources(dispatch) .add_destinations(drop1)
        
        cnexttrans4 = CNextTrans() .set_name("cnexttrans4")
        cnexttrans4 .add_sources(drop1) .add_destinations(dispatch)
        ...
        datatrans9 .add_sources(dispatch) .add_destinations(print1)
